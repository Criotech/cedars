...
const Testimonies = () => {
  ...
  const [confessions, setTestimonies] = useState([]);

console.log(confessions, 'hello worldm')
  const fetchAllAttendances = async () => {
    try {
      let res = await ApiService.fetchTestimonies();
  ...
  return (
    <div>im
      <DashboardLayout title='Testimonies'>
        <section className="users-section">
          ...
          <TestimoniesComponent data={confessions} />
