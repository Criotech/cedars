...
import AttendancesComponent from '../../components/Attendances';
...
console.log(attendances, 'hello worldm')
  const fetchAllAttendances = async () => {
    try {
      let res = await ApiService.fetchAttendances();
      setAttendaces(res.data.data);
    } catch (e) {
      console.log(e)
    }
  }
  ...
  return (
    <div>im
      <DashboardLayout title='Attendances'>
        <section className="users-section">
          ...
          <AttendancesComponent data={attendances} />
