...
import ConfessionComponent from '../../components/Confessions';
...
console.log(confessions, 'hello worldm')
  const fetchAllAttendances = async () => {
    try {
      let res = await ApiService.fetchConfessions();
  ...
  return (
    <div>im
      <DashboardLayout title='Confessions'>
        <section className="users-section">
          ...
          <ConfessionComponent data={confessions} />
