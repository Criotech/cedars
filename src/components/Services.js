...
const Services = ({ data, setPerPage, prev, next, per_page, page, totalUsers, loading, handlePCMSearch, filterPCMByStatus, pcmSearchText }) => {
            ...
            <table className="table">
              <thead>
                <tr>
                  ...
                  <th scope="col">Get Attendance</th>
